...
<div class="jumbotron text-center">
  ...
  <p><b>E-EXAMINATION</b></p>
  <p>Project By: Rujul S., Kunal S., Dipak D.</p>
  <!--  form>
...
<div class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-8">
      <h2><center>Our Values</center></h2>
      <h4><strong>MISSION:</strong><b>Our mission is using one platform for examinations. Reduce paperwork and offering quick and accurate results.</b></h4>
      <h4><strong>VISION:</strong><b>Our vision of Online Exam System is more popularly helps for our modern age system. It helps us to use the present  technology into examiantion system . It can be helpful for quick and accurate results.Through it helps for only limited sector of people , it is cost efficient , eco friendly and so on.</b></p>
    </div>
  </div>
</div>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>E-Examination</h4>
	  <p><b>Multiple users One platform</b></p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-euro logo-small"></span>
      <h4>COST OPTIMISED</h4>
      <p><b>Reduces paper work</b></p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-user logo-small"></span>
      <h4>USER SATISFACTION</h4>
      <p><b>User satisfaction is our satisfaction..</b></p>
    </div>
  </div>
  <br><br>
  <div class="row slideanim">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Very good iniative. I am so happy with the result!"<br><span>Rujul Sonawane, Student, Sterling-Nerul</span></h4>
      </div>
      <div class="item">
        <h4>"One word... WOW!!"<br><span>Dipak Dudhal, Student, MET-Bandra</span></h4>
      </div>
      <div class="item">
        <h4>"Much happy with this startup"<br><span>Kunal Sawant, Professor, BharatiVidyapeeth-Belapur </span></h4>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  <div class="row">
    ...
    <div class="col-sm-5">
      <h2>Contact Us</h2><br>
      <h4><b>You Can Code(YCC) Pvt. Ltd., Nerul.</b><br> You Can Reach Us Through: support@ycc.com <br> Call Us On: +91 99999 88888, Timings: 10:00am to 06:00pm IST. We are Closed on Sunday.</h4>
    </div>
  </div>
</div>
</center>
...
<div id="feedback" class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-5">
      <h2><center>You are free to provide us your suggestions and feedback.</center></h2>
    </div>
...
{echo'
      ...
      <textarea class="form-control" id="comments" name="feedback" placeholder="Comment" rows="2"></textarea><br>
      <div class="row">
        <div class="col-sm-12 form-group">
          <button class="btn btn-default btn-lg pull-center" name="submit" input type="submit">Submit</button>
        </div>
      </form>';}?>
      </div>
    </div>
